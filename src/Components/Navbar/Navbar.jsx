...
export default function Navbar({ toggleCart }) {
  ...
  return (
    <div className="z-50 sticky top-0">
      {/* Large screen */}
      <nav className="hidden lg:flex w-full  h-[100px] bg-yellow-800 shadow-md items-center px-5">
        <div className="w-full h-full">
          <p className=" text-4xl font-medium py-5.5 text-amber-400">
            Café Golden Léaf
          </p>
        </div>
      ...
      {/* Mobile screen */}
      <div className="lg:hidden flex items-center  justify-between h-[60px] px-5 bg-yellow-800 shadow-md">
